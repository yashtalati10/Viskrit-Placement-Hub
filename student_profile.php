            ...
            <div class="col-lg-8 col-md-10 col-sm-12">
                <div class="profile-container bg-light p-4 rounded shadow-lg">
                    ...
                    <div class="profile-info card p-3 shadow-sm mb-4">
                        <div class="row">
                            <div class="col-md-6">
                                <p><i class="fas fa-user"></i> <strong>Username:</strong>
                                    <?php echo $row['username']; ?></p>
                                <p><i class="fas fa-id-badge"></i> <strong>First Name:</strong>
                                    <?php echo strtoupper($row['first_name']); ?></p>
                                <p><i class="fas fa-id-badge"></i> <strong>Last Name:</strong>
                                    <?php echo strtoupper($row['last_name']); ?></p>
                            </div>
                            <div class="col-md-6">
                                <p><i class="fas fa-building"></i> <strong>Department:</strong>
                                    <?php echo $row['department']; ?></p>
                                <p><i class="fas fa-phone"></i> <strong>Mobile:</strong> <?php echo $row['mobile']; ?>
                                </p>
                                <p><i class="fas fa-envelope"></i> <strong>Email:</strong> <?php echo $row['email']; ?>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card p-3 shadow-sm mb-4">
                        ...
                        <form action="update_contact_info.php" method="POST">
                            ...
                            <button type="submit" class="btn btn-info1 w-100"><i class="fas fa-save"></i> Update
                                Info</button>
                        </form>
                    </div>
                    ...
                    <div class="card p-3 shadow-sm mb-4">
                        ...
                        <form action="change_password.php" method="POST">
                            <button type="submit" class="btn btn-danger w-100"><i class="fas fa-key"></i> Change
                                Password</button>
                        </form>
                    </div>
                    ...
                    <?php if ($row['resume_file_path'] == ''): ?>
                        <div class="card p-3 shadow-sm mb-4">
                            ...
                            <form action="upload_resume.php" method="post" enctype="multipart/form-data">
                                ...
                                <button type="submit" class="btn btn-info1 w-100"><i class="fas fa-file-upload"></i>
                    ...
                    <?php if ($row['resume_file_path'] != ''): ?>
                        <div class="card p-3 shadow-sm mb-4">
                            <div class="d-flex justify-content-between">
                                <a href="<?php echo $row['resume_file_path']; ?>" target="_blank" class="btn btn-info1 w-45">
                                    <i class="fas fa-file-alt"></i> View Resume
                                </a>
                                <a href="delete_resume.php?username=<?php echo $row['username']; ?>"
