  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="card text-center shadow-sm">
          <div class="card-body">
            ...
            <a href="available_jobs.php" class="btn btn-sm btn-primary d-flex align-items-center justify-content-center">
              View All Jobs
      ...
      <div class="col-md-4">
        <div class="card text-center shadow-sm">
          <div class="card-body">
            <h6 class="card-title">Your Applications</h6>
            <h2 class="fw-bold text-danger"><?php echo $application_count['TotalApplications']; ?></h2>
            <a href="student_my_applications.php"
